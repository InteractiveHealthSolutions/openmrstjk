 ...
 */
@Handler(supports={DotsProgramLocationCohortDefinition.class})
public class DotsProgramLocationCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public DotsProgramLocationCohortDefinitionEvaluator() {}
    ...
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
      	...
      	DotsProgramLocationCohortDefinition cd = (DotsProgramLocationCohortDefinition) cohortDefinition;
