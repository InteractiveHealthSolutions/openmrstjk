 ...
 */
@Handler(supports={TypeOfDiagnosisCohortDefinition.class})
public class TypeOfDiagnosisCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public TypeOfDiagnosisCohortDefinitionEvaluator() {}
    ...
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
    	...
    	TypeOfDiagnosisCohortDefinition cd = (TypeOfDiagnosisCohortDefinition) cohortDefinition;
    	//Cohort c = null;
