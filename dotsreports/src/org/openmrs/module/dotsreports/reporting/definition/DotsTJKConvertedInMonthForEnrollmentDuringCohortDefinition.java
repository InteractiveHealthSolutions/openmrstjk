...
public class DotsTJKConvertedInMonthForEnrollmentDuringCohortDefinition extends ProgramEnrollmentCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public DotsTJKConvertedInMonthForEnrollmentDuringCohortDefinition() {
		super();
	}
