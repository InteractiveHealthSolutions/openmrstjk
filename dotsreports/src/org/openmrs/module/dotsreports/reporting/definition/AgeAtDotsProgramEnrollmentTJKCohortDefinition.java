...
public class AgeAtDotsProgramEnrollmentTJKCohortDefinition extends ProgramEnrollmentCohortDefinition {
	 ...
	 * Default Constructor
	 */
	public AgeAtDotsProgramEnrollmentTJKCohortDefinition() {
		super();
	}
