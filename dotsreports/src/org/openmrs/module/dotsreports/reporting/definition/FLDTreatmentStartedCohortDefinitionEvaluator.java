 ...
 */
@Handler(supports={FLDTreatmentStartedCohortDefinition.class})
public class FLDTreatmentStartedCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public FLDTreatmentStartedCohortDefinitionEvaluator() {}
    ...
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {	
    	FLDTreatmentStartedCohortDefinition cd = (FLDTreatmentStartedCohortDefinition) cohortDefinition;
