 ...
 */
@Handler(supports={SLDTreatmentStartedCohortDefinition.class})
public class SLDTreatmentStartedCohortDefinitionEvaluator implements CohortDefinitionEvaluator {

	/**
	 * Default Constructor
	 */
	public SLDTreatmentStartedCohortDefinitionEvaluator() {}
    ...
    public Cohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {	
    	SLDTreatmentStartedCohortDefinition cd = (SLDTreatmentStartedCohortDefinition) cohortDefinition;
