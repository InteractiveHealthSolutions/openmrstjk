...
public class TB08TJK implements ReportSpecification {
	...
	public ReportData evaluateReport(EvaluationContext context) {
		...
		CohortDefinition rifResistant	= Cohorts.getRRDetectionFilter(startDate, endDate);
		CohortDefinition mdrWithoutRif = Cohorts.getMdrDetectionFilter(startDate, endDate);
		CohortDefinition mdr = ReportUtil.getCompositionCohort("OR", rifResistant,mdrWithoutRif);
		CohortDefinition pdr = Cohorts.getPolydrDetectionFilter(startDate, endDate);
