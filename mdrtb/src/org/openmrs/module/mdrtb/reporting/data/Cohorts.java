...
import org.openmrs.module.mdrtb.reporting.definition.CauseOfDeathCohortDefinition;
...
public class Cohorts {
	...
	*/
	...
	public static CohortDefinition getDiedByTB(Date fromDate, Date toDate)
	{
		...
		cd.setToDate(toDate);
		cd.setCauseType(CauseOfDeathType.CAUSE_TB); //includes both tb and tbhiv
	...
	public static CohortDefinition getDiedByNonTB(Date fromDate, Date toDate)
	{
		...
		cd.setFromDate(fromDate);
		cd.setToDate(toDate);
		cd.setCauseType(CauseOfDeathType.CAUSE_NONTB);
	...
	public static CohortDefinition getDiedByTBHIV(Date fromDate, Date toDate)
	{
		...
		cd.setFromDate(fromDate);
		cd.setToDate(toDate);
		cd.setCauseType(CauseOfDeathType.CAUSE_TBHIV);
