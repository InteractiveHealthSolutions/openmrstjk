...
public class MdrtbQueryService {
    ...
    public static Cohort getPatientsDiedByTB(EvaluationContext context,Date startDate, Date endDate)
    {
    	...
    	Integer causeOfDeath 	= Context.getService(MdrtbService.class).getConcept(TbConcepts.CAUSE_OF_DEATH).getConceptId();
    	Integer causeNonTb 		= Context.getService(MdrtbService.class).getConcept(TbConcepts.DEATH_BY_OTHER_DISEASES).getConceptId();
    	Integer txOutcome		= Context.getService(MdrtbService.class).getConcept(TbConcepts.TB_TX_OUTCOME).getConceptId();
    	Integer outcomeDied     = Context.getService(MdrtbService.class).getConcept(TbConcepts.DIED).getConceptId();
    ...
    public static Cohort getPatientsByCauseOfDeath(EvaluationContext context, Date minResultDate, Date maxResultDate, Concept... causeType) {
    	...
    	Integer causeOfDeath = Context.getService(MdrtbService.class).getConcept(TbConcepts.CAUSE_OF_DEATH[0]).getConceptId();
